...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  heading: 'Em 1 minuto, eu',
  headingEm: 'conto a minha história.',
  preText: 'Eu te conto o que aprendi atravessando o pânico durante a minha gestação e o que ofereço hoje pras gestantes que chegam até mim.',
  postText: 'Esse trabalho nasceu da minha história. Continue rolando pra entender como eu cuido.',
}
// ════════════════════════════════════════════════════════════════════
