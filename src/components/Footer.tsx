...
const COPY = {
  ...
  heading: 'Você não precisa atravessar essa gestação sozinha.',
  headingEm: 'Eu já estive onde você está.',
  subtitle: 'Agende sua sessão e a gente conversa direto no WhatsApp. Sem formulário longo, sem espera.',
