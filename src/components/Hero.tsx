...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'GESTANTE EM PÂNICO ANTECIPADO',
  h1: 'Você está grávida e o',
  h1Em: 'parto já começou na sua cabeça.',
  subtitle: 'Se o medo do parto está tirando seu sono, sua paz e a alegria que era pra ser dessa fase, existe um caminho de cuidado emocional pensado pra gestante.',
  ctaPrimary: 'Agendar sessão com Carla',
  ctaSecondary: 'ou role pra entender melhor',
}
// ════════════════════════════════════════════════════════════════════
